...
class FirstForgetpasswordScreen extends StatelessWidget {
  const FirstForgetpasswordScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // تعريف المتحكم يدوياً إذا لم يتعرف عليه GetView تلقائياً
    final FirstForgetPasswordController controller = Get.find<FirstForgetPasswordController>();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: CustomLink(text: "forget_password_link".tr,onPressed: (){}),
                    ),
                    ...
                    Obx(
                        ...
                        onPressed: () {
                          ...
                          controller.firstforgetpassword();
                        },
                      ),
                    ),
