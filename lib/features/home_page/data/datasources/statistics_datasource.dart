...
class StatisticsRemoteDataSource {
  ...
  Future<StatisticsModel> getContStudents() async{
    final response = await http.get(
      Uri.parse('https://darkseagreen-salamander-685564.hostingersite.com/api/v1/admin/count/student',),
      headers: {
  ...
  Future<StatisticsModel> getCountTeachcers() async{
    final response = await http.get(
      Uri.parse('https://darkseagreen-salamander-685564.hostingersite.com/api/v1/admin/count/teacher',),
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ${token}',
      },
