...
class LibraryBookScreen extends StatelessWidget {
  const LibraryBookScreen({super.key, required this.libraryController});
                ...
                child: LayoutBuilder(
                    builder: (BuildContext context, BoxConstraints constraints) {
                      ...
                      return Obx(() {
                        ...
                        if (libraryController.libraryBooks.isEmpty) {
                          return  Center(child: Text("No Enrichment books found".tr));
                        }
                        return ListView(
                            children: [
                              ...
                              ListView.builder(
                                  ...
                                  itemCount: libraryController.libraryBooks.length,
                                  itemBuilder: (context, index) {
                                    final book = libraryController.libraryBooks[index];
                                    return Container(
